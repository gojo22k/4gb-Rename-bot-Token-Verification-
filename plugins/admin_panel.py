...
async def handle_premium_selection(bot, query):
    plan = query.data
    user_id = query.from_user.id
    # Add user to the premium users list based on the selected plan
    await db.add_premium_user(user_id, plan)
    await query.answer(f"You have been upgraded to the {plan} plan.")